 ...
 * keys.
 *
 * Remark: Copy from https://dzone.com/articles/javafx-numbertextfield-and on 2016-10-27.
 *
 * @author Thomas Bolz
 */
public class NumericSpinner extends HBox 
{
    ...
    public NumericSpinner(BigDecimal value, BigDecimal stepWidth, NumberFormat nf)
    {
        ...
        incrementButton.setPrefHeight(buttonSize);
        incrementButton.setMinHeight(buttonSize);
        incrementButton.setMaxHeight(buttonSize);
        ...
        decrementButton.setPrefHeight(buttonSize);
        decrementButton.setMinHeight(buttonSize);
        decrementButton.setMaxHeight(buttonSize);
